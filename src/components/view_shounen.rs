            ...
            <>
                <div class="hero-body">
                    ...
                    <div class="content">
                        ...
                        <AppAnchor route=AppRoute::Eps(112)>
                            <Card 
                                score="4.6".to_string() 
                            ...
                            <div class="padding-40px">
                        <AppAnchor route=AppRoute::Eps(408)>
                            <Card 
                                score="4.1".to_string() 
                            ...
                            <div class="padding-40px">
                        <AppAnchor route=AppRoute::Eps(150)>
                            <Card 
                                score="4.2".to_string() 
                            ...
                            <div class="padding-40px">
                        <AppAnchor route=AppRoute::Eps(80)>
                            <Card 
                                score="4.8".to_string() 
                        ...
                        <AppAnchor route=AppRoute::Eps(335)>
                            ...
                            <div class="padding-40px">
                        <AppAnchor route=AppRoute::Eps(140)>
                            <Card 
                                score="4.9".to_string() 
                            ...
                            <div class="padding-40px">
                        <AppAnchor route=AppRoute::Eps(316)>
                            <Card 
                                score="4.2".to_string() 
                            ...
                            <div class="padding-40px">
                        <AppAnchor route=AppRoute::Eps(354)>
                            <Card 
                                score="4.9".to_string() 
                            ...
                            <div class="padding-40px">
                        <AppAnchor route=AppRoute::Eps(45)>
                            <Card 
                                score="4.9".to_string() 
                            ...
                            <div class="padding-40px">
                        <AppAnchor route=AppRoute::Eps(31)>
                            <Card 
                                score="4.9".to_string() 
                            ...
                            <div class="padding-40px">
                        <AppAnchor route=AppRoute::Eps(332)>
                            <Card 
                                score="4.9".to_string() 

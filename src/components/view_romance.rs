            ...
            <>
                <div class="hero-body">
                    ...
                    <div class="content">
                        ...
                        <AppAnchor route=AppRoute::Eps(88)>
                            <Card 
                                score="4.6".to_string() 
                            ...
                            <div class="padding-40px">
                        <AppAnchor route=AppRoute::Eps(364)>
                            <Card 
                                score="4.1".to_string() 
                            ...
                            <div class="padding-40px">
                        <AppAnchor route=AppRoute::Eps(43)>
                            <Card 
                                score="4.2".to_string() 
                            ...
                            <div class="padding-40px">
                        <AppAnchor route=AppRoute::Eps(458)>
                            <Card 
                                score="4.8".to_string() 
                            ...
                            <div class="padding-40px">
                        <AppAnchor route=AppRoute::Eps(259)>
                            <Card 
                                score="4.9".to_string() 
                            ...
                            <div class="padding-40px">
                        <AppAnchor route=AppRoute::Eps(389)>
                            <Card 
                                score="4.9".to_string() 
                            ...
                            <div class="padding-40px">
                        <AppAnchor route=AppRoute::Eps(110)>
                            <Card 
                                score="4.2".to_string() 
